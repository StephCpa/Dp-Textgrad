...
```sh
conda create --name dp-textgrad
conda activate dp-textgrad
cd dp-textgrad
pip install -e .
...
For more installation instructions, please refer to the [installation instructions](https://github.com/zou-group/dp-textgrad?tab=readme-ov-file#installation) in the [textgrad](https://github.com/zou-group/dp-textgrad) repository. 
