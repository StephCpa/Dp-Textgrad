...
from dp_textgrad.autograd.string_based_ops import BackwardContext, StringBasedFunction
from dp_textgrad.loss import ImageQALoss
...
class TextDetectorModule(StringBasedFunction):
    ...
    def _build_text_detector_model(self):
        ...
        # load the model
        root = platformdirs.user_cache_dir("dp_textgrad")
