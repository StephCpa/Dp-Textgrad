...
from dp_textgrad.engine.guidance import GuidanceEngine
...
class GuidedTextualGradientDescent(TextualGradientDescent):
    def __init__(self, 
        ...
        :param optimizer_system_prompt: system prompt to the optimizer, defaults to dp_textgrad.prompts.OPTIMIZER_SYSTEM_PROMPT. Needs to accept new_variable_start_tag and new_variable_end_tag
