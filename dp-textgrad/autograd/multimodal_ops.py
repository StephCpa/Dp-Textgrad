...
from dp_textgrad.defaults import (SYSTEM_PROMPT_DEFAULT_ROLE, 
                               VARIABLE_OUTPUT_DEFAULT_ROLE)
from dp_textgrad.variable import Variable
from dp_textgrad.engine import EngineLM, validate_multimodal_engine
...
class MultimodalLLMCall(Function):
    ...
    def forward(self, 
        ...
        >>> from dp_textgrad import Variable, get_engine
        >>> from dp_textgrad.autograd import MultimodalLLMCall
