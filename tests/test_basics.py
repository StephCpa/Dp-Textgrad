...
from dp_textgrad import Variable, TextualGradientDescent, BlackboxLLM, sum
from dp_textgrad.engine.base import EngineLM
from dp_textgrad.engine.openai import ChatOpenAI
from dp_textgrad.autograd import LLMCall, FormattedLLMCall
...
def test_set_backward_engine():
    from dp_textgrad.config import set_backward_engine, SingletonBackwardEngine
    from dp_textgrad.engine.openai import ChatOpenAI
...
def test_get_engine():
    from dp_textgrad.engine import get_engine
    from dp_textgrad.engine.openai import ChatOpenAI
    from dp_textgrad.engine_experimental.litellm import LiteLLMEngine
...
# Test importing main components from dp_textgrad
def test_import_main_components():
    from dp_textgrad import Variable, TextualGradientDescent, EngineLM
    from dp_textgrad.engine.openai import ChatOpenAI
    from dp_textgrad import BlackboxLLM
...
def test_multimodal():
    from dp_textgrad.autograd import MultimodalLLMCall, LLMCall
